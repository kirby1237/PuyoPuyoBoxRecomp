...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "PuyoPuyoBox",
    .project_root_env = "PUYOPUYOBOXRECOMP_PROJECT_ROOT",
    .build_dir_env = "PUYOPUYOBOXRECOMP_BUILD_DIR",
    .force_setup_env = "PUYOPUYOBOXRECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLPS_031.14_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "PuyoPuyoBox_Recompiled",
    .prepare_note =
