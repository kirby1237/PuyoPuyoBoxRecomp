...
#
# Writes: dist/ppb-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix ppb \
  --exe-name PuyoPuyoBox_Recompiled \
  --display-name "PuyoPuyoBox Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned PuyoPuyoBox disc" \
